<template>
  <div>
    ...
    <button type="button" class="btn btn-success btn-sm" @click="download">
      Download
    </button>
    ...
    <button
      ...
      data-bs-target="#addAgentToGroupModal"
    >
      Agents in group
    </button>
  ...
  methods: {
    initGroup() {
      this.group = {
        id: null,
        name: "",
        description: "You are a helpfull group",
        graph: { nodes: [], links: [] },
        created: "",
      };
    },
